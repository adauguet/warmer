...
var $author$project$Coordinate$distance = F2(
	function (c1, c2) {
		return $elm$core$Basics$abs(c2.row - c1.row) + $elm$core$Basics$abs(c2.column - c1.column);
	});
...
var $author$project$Coordinate$fromInt = F2(
	function (size, _int) {
		return {
			column: A2($elm$core$Basics$modBy, size, _int),
			row: (_int / size) | 0
		};
	});
...
var $author$project$Coordinate$toInt = F2(
	function (size, _v0) {
		var row = _v0.row;
		var column = _v0.column;
		return (row * size) + column;
	});
var $author$project$CoordinateTests$suite = A2(
				...
				[
					...
					function (_v0) {
						return A2(
							...
							A2($author$project$Coordinate$fromInt, 10, 0),
							{column: 0, row: 0});
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2($author$project$Coordinate$fromInt, 10, 2),
							{column: 2, row: 0});
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2($author$project$Coordinate$fromInt, 10, 24),
							{column: 4, row: 2});
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2($author$project$Coordinate$fromInt, 10, 57),
							{column: 7, row: 5});
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2($author$project$Coordinate$fromInt, 10, 99),
							{column: 9, row: 9});
					})
				])),
			A2(
				...
				[
					...
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
								$author$project$Coordinate$toInt,
								10,
								{column: 0, row: 0}),
							0);
					}),
				...
				[
					...
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
								$author$project$Coordinate$distance,
								{column: 1, row: 0},
								{column: 4, row: 2}),
							5);
					}),
...
var $author$project$List$Extra$chunk = F2(
	function (size, list) {
		var _v0 = _Utils_Tuple2(
		...
		if (!_v0.a.b) {
			...
			return A2(
				$elm$core$List$cons,
				head,
				A2($author$project$List$Extra$chunk, size, tail));
		}
	});
var $author$project$List$ExtraTests$suite = A2(
	$elm_explorations$test$Test$describe,
	'chunk',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2($author$project$List$Extra$chunk, -1, _List_Nil),
					_List_Nil);
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2($author$project$List$Extra$chunk, 0, _List_Nil),
					_List_Nil);
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2(
						$author$project$List$Extra$chunk,
						2,
...
var $author$project$Test$Generated$Main3406321642$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/adauguet/Projects/elm/warmer/tests/CoordinateTests.elm', '/Users/adauguet/Projects/elm/warmer/tests/List/ExtraTests.elm']),
		processes: 8,
	...
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'CoordinateTests',
				_List_fromArray(
					[$author$project$CoordinateTests$suite])),
				A2(
				$elm_explorations$test$Test$describe,
				'List.ExtraTests',
				_List_fromArray(
					[$author$project$List$ExtraTests$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main3406321642':{'init':$author$project$Test$Generated$Main3406321642$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-40740.sock";
